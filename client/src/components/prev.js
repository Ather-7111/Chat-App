...
//-------------------------------------------------------------
{
    (((message?.attachmentUrl || message?.attachment?.url)?.startsWith(getformat(message?.filetype)))
        || ((message?.attachmentUrl || message?.attachment?.url)?.endsWith(getformat(message?.filetype)))) ? (
        <div
            key={getformat(message?.filetype)}
            ...
            >
                <FileIcon
                    extension={getformat(message?.filetype)}
                    {...defaultStyles[getformat(message?.filetype)]}
            ...
            <div
                ...
                <p className="text-white hover:underline">
                    {`View ${getformat(message?.filetype)} attachment`}
                </p>
                <a
...

{
    fileTypes.map((fileType) => {
            ...
            const fileTypeMime = (message?.attachmentUrl || message?.attachment?.url)?.split(';')?.shift();
            console.log("fileTypeMime", (message?.attachmentUrl || message?.attachment?.url)?.split(';')?.shift())

            const fileTypeExtension = getformat(message?.filetype)
            console.log("fileTypeExtension-->", fileTypeExtension)


            const isSenderUrlExists = ((message?.attachmentUrl || message?.attachment?.url)?.startsWith(getformat(message?.filetype)))
            const isReceiverUrlExists = ((message?.attachmentUrl || message?.attachment?.url)?.endsWith(getformat(message?.filetype)))

            if (((message?.attachmentUrl || message?.attachment?.url)?.startsWith(getformat(message?.filetype)))
                || ((message?.attachmentUrl || message?.attachment?.url)?.endsWith(getformat(message?.filetype)))) {
                return (
                    <div
                        key={getformat(message?.filetype)}
